...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Ellenőrizzük, hogy érkezett-e email adat a POST-ban
    if (isset($_POST['email'])) {
        ...
        // Az e-mail küldő függvény meghívása
        feldolgozEmail($recipient);
    } else {
...
function sendEmail($recipient)
{
    ...
    try {
        ...
        $mail->Body = 'Kedves Felhasználó, a rendelés státusza frissült! <br> Új státusz: Átadva a futárszolgálatnak'; // Email tartalma
