...
<body>
    <div class="container">
        ...
        <!--Main Content-->
        <main>
            <h1>E-mail és hírlevél küldése</h1>
            <br>
            <form action="php_email.php" method="post">
                <label for="email">Címzett:</label>
                <input type="email" id="email" name="email" required>
                <label for="subject">Tárgy:</label>
                <input type="text" id="subject" name="subject" required>
                <label for="message">Üzenet:</label>
                <textarea name="message" id="message" required></textarea>
                <button type="submit" name="send_email">Levél küldése</button>
            </form>
            <form method="post" action="newsletter_send.php">
                <button type="submit" name="send_newsletter">Hírlevél küldése</button>
            </form>
