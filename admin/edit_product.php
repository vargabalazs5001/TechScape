...
<head>
    ...
    <title>TechScape | Termék módosítása</title>
...
<body>
    <div class="container">
        ...
        <!--Main Content-->
        <main>
            <form id="feltolt.php" action="edit_product_sql.php" method="post" enctype="multipart/form-data">
                ...
                <input type="number" id="unit_price" name="unit_price" value="<?php echo $product['unit_price']; ?>"
                    required>
                <button type="submit" name="modify_product">Termék módosítása</button>
            </form>
        </main>
        <!--End of Main Content-->
